...
%  resample_method - 'simple', 'reduce', 'strongest'
...
function [delay, gain] = power_delay_profile(name, T_s, resample_method, N_taps)
  ...
  elseif strcmpi(resample_method, 'strongest')
    [delay, gain] = pdp_resample_strongest(delay, gain, T_s, 1e-9, N_taps);
  else
